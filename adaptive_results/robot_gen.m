...
PANDAsymp = SerialLink([L1 L2 L3 L4 L5],'name','PANDAsymp'); % real robot
...
PANDAsymp.links(1).m = m1;
PANDAsymp.links(2).m = m2;
PANDAsymp.links(3).m = m3;
PANDAsymp.links(4).m = m4;
PANDAsymp.links(5).m = m5;
% PANDAsymp.links(6).m = m6;
% PANDA.links(7).m = m7;
...
PANDAsymp.links(1).r = r1;
PANDAsymp.links(2).r = r2;
PANDAsymp.links(3).r = r3;
PANDAsymp.links(4).r = r4;
PANDAsymp.links(5).r = r5;
% PANDAsymp.links(6).r = r6;
% PANDA.links(7).r = r7;
...
PANDAsymp.links(1).I = I1; 
PANDAsymp.links(2).I = I2;
PANDAsymp.links(3).I = I3; 
PANDAsymp.links(4).I = I4;
PANDAsymp.links(5).I = I5; 
% PANDAsymp.links(6).I = I6; 
% PANDA.links(7).I = I7; 
